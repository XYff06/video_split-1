  ...
  <section class="panel prompt-panel">
    <div class="prompt-panel-topbar">
      ...
      <div class="fission-controls" v-if="currentVideoResult && currentSegment">
        ...
        />
        <button class="primary-button fission-action-button" :disabled="disableCurrentVideoButton" @click="$emit('generate-current-video')">
          {{ isGeneratingCurrentVideo ? '当前视频裂变中...' : '当前视频裂变' }}
        </button>
        <button class="ghost-button fission-action-button" :disabled="disableAllVideosButton" @click="$emit('generate-all-videos')">
...
defineEmits(['generate-current-video', 'generate-all-videos'])
